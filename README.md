...
🎓 Studying **BSc Cybersecurity** at **Bath Spa University RAK**, actively working on academic and real-world cyber projects.  
🔭 Actively seeking **SOC Analyst, Cybersecurity Analyst**, or **Pen Tester** roles to gain production-level experience.

---

## 🚀 Career Goals

- 🛡️ Real-time SOC experience (SIEM, alerting, IR workflows)  
- 🧠 Advanced threat detection, malware analysis, and forensics  
- 🛠️ Deliver freelance projects (penetration testing, awareness training)  
- 🎓 Mentor cybersecurity beginners and grow my knowledge-sharing platform
...
| Project | Description | GitHub | Google Drive |
|--------|-------------|--------|--------------|
| **PassShield Password Manager** | Python-Tkinter password manager with hashing (University Project) | [🔗 GitHub](https://github.com/PassShield/Passshield-collab) | [🔗 Drive](https://drive.google.com/drive/folders/1AeBN33Mjp7SPsDn6GKJD0mJ3ZVlHvUMo?usp=sharing) |
| **Python Vending Machine** | CLI-based vending machine for Python logic | [🔗 GitHub](https://github.com/Bath-Spa-Students/utility-app-Percyana552/tree/main) | — |
| **PotterDB API Task** | REST API project integrating Harry Potter DB | — | [🔗 Drive](https://drive.google.com/drive/folders/1vs4JcFC1-TTaupusDF6GKmyAZQklLlgp?usp=sharing) |
...
| **CompTIA CySA+ Labs** | Threat hunting, IR workflows, detection | [🔗 GitHub](https://github.com/Petrasec2025/CompTIA-CYSA-Labs) |
...
| [🔧 CySA+ Labs](https://github.com/Petrasec2025/CompTIA-CYSA-Labs) | Threat Detection & IR |
...
**📘 Ongoing Learning (Online Platforms)**
...
- 💼 **Open to Roles:** SOC Analyst • Cybersecurity Analyst • Junior Pentester  
- 🧪 **Freelance:** Penetration Testing • Security Awareness • VAPT  
- 🎓 **Mentorship:** Cybersecurity Students • Beginners • Career Changers
